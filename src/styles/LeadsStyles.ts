...
export const LEADS_FIELD_BOX_STYLES: SxProps<Theme> = {
    display: 'flex',
...
export const LEADS_FIELD_LABEL_STYLES: SxProps<Theme> = {
    fontSize: '14px',
    fontWeight: 500,
    color: '#374151',
    mb: 0.5,
...
export const LEADS_REQUIRED_ASTERISK_STYLES: React.CSSProperties = {
    color: '#ef4444',
    marginLeft: '2px',
};

// TextField Styles
export const LEADS_TEXT_FIELD_STYLES: SxProps<Theme> = {
...
// Select Styles
export const LEADS_SELECT_STYLES: SxProps<Theme> = {
    backgroundColor: '#ffffff',
    borderRadius: '8px',
    fontSize: '14px',
...
export const LEADS_MENU_ITEM_STYLES: SxProps<Theme> = {
    fontSize: '14px',
    color: '#374151',
    py: 1.25,
    px: 2,
