                        ...
                        <Card sx={{ borderRadius: '7px' }}>
                            ...
                            >
                                <div style={{ width: '32%' }}>
                                    ...
                                    <div className="title3">{userDetails?.user_details?.email || '---'}</div>
                                </div>
                                <div style={{ width: '32%' }}>
                                ...
                                <div style={{ width: '32%' }}>
                                    ...
                                    <div className="title3">
                                        <Avatar alt={'sdf'}>{userDetails?.user_details?.profile_pic}</Avatar>
                                    </div>
                                </div>
                            </div>
                            <div
                            ...
                            >
                                ...
                                <div style={{ width: '32%' }}>
                                    ...
                                    <div className="title3">{userDetails?.date_of_joining || '---'}</div>
                                </div>
                                {/* <div style={{ width: '32%' }}>
                            ...
                            <div style={{ marginTop: '15px' }}>
                                ...
                                >
                                    <div style={{ width: '32%' }}>
                                        ...
                                        <div className="title3">{userDetails?.address?.address_line || '---'}</div>
                                    </div>
                                    <div style={{ width: '32%' }}>
                                        <div className="title2">Street</div>
                                        <div className="title3">{userDetails?.address?.street || '---'}</div>
                                    </div>
                                    <div style={{ width: '32%' }}>
                                        <div className="title2">City</div>
                                        <div className="title3">{userDetails?.address?.city || '---'}</div>
                                    </div>
                                </div>
                                <div
                                    style={{
                                ...
                                >
                                    <div style={{ width: '32%' }}>
                                        ...
                                        <div className="title3">{userDetails?.address?.postcode || '---'}</div>
                                    </div>
                                    <div style={{ width: '32%' }}>
                                        <div className="title2">State</div>
                                        <div className="title3">{userDetails?.address?.state || '---'}</div>
                                    </div>
                                    <div style={{ width: '32%' }}>
                                        <div className="title2">Country</div>
                                        <div className="title3">{userDetails?.address?.country || '---'}</div>
                                    </div>
                                </div>
                            </div>
                            {/* Description */}
