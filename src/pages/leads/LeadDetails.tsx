...
function LeadDetails(props: any) {
    ...
    const sendComment = () => {
        ...
        const data = {
            Comment: inputValue || note,
            lead_attachment: attachments,
        };
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {leadDetails?.tags?.length
                                        ? leadDetails?.tags.map((tagData: any) => <Label tags={tagData} />)
                                        : ''}
                                </Stack>
                            </div>
                            <div
                            ...
                            >
                                <div style={{ width: '32%' }}>
                                    ...
                                    <div className="title3">{leadDetails?.close_date || '---'}</div>
                                </div>
                                <div style={{ width: '32%' }}>
                                ...
                                <div style={{ width: '32%' }}>
                                    ...
                                    <div className="title3">{leadDetails?.organization || '---'}</div>
                                </div>
                            </div>
                            <div className="detailList">
                                ...
                                <div style={{ width: '32%' }}>
                                    ...
                                    <div className="title3">{leadDetails?.probability || '---'}</div>
                                </div>
                                <div style={{ width: '32%' }}>
                                    <div className="title2">website</div>
                                    <div className="title3">
                                        {leadDetails?.website ? <Link>{leadDetails?.website}</Link> : '---'}
                                    </div>
                                </div>
                            </div>
                            <div className="detailList">
                                ...
                                <div style={{ width: '32%' }}>
                                    ...
                                    <div className="title3">
                                        {leadDetails?.skype_ID ? <Link>{leadDetails?.skype_ID}</Link> : '---'}
                                    </div>
                                </div>
                                <div style={{ width: '32%' }}>
                                    <div
                            ...
                            <div style={{ marginTop: '2%' }}>
                                ...
                                >
                                    <div style={{ width: '32%' }}>
                                        ...
                                        <div className="title3">{leadDetails?.first_name || '---'}</div>
                                    </div>
                                    <div style={{ width: '32%' }}>
                                        <div className="title2">Last Name</div>
                                        <div className="title3">{leadDetails?.last_name || '---'}</div>
                                    </div>
                                    <div style={{ width: '32%' }}>
                            ...
                            <div style={{ marginTop: '2%' }}>
                                ...
                                >
                                    <div style={{ width: '32%' }}>
                                        ...
                                        <div className="title3">{leadDetails?.address_line || '---'}</div>
                                    </div>
                                    <div style={{ width: '32%' }}>
                                ...
                                <div className="detailList">
                                    <div style={{ width: '32%' }}>
                                        ...
                                        <div className="title3">{leadDetails?.postcode || '---'}</div>
                                    </div>
                                    <div style={{ width: '32%' }}>
                                    ...
                                    <div style={{ width: '32%' }}>
                                        ...
                                        <div className="title3">{leadDetails?.country || '---'}</div>
                                    </div>
                                </div>
                            </div>
                            {/* Description */}
